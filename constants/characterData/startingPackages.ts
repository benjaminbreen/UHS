...
export const STARTING_PACKAGES: Record<string, { 
    ...
    // =======================================================================
    // == FALLBACK & GENERIC ROLES (More thoughtfully assigned)
    // =======================================================================
    'Wanderer': { equipment: { head: 'STRAW_HAT', legs: 'WORKER_TROUSERS', torso: 'WOOL_TUNIC',  feet: 'LEATHER_BOOTS', main_hand: 'STICK' }, inventory: ['BREAD', 'GOURD_FLASK', 'MAP'],  companions: ['DOG'] },
    'Artisan': { equipment: { torso: 'LEATHER_APRON', legs: 'WORKER_TROUSERS',  feet: 'LEATHER_BOOTS' }, inventory: ['HAMMER', 'KNIFE', 'ROPE'] },
    'Commoner': { equipment: { torso: 'SIMPLE_TUNIC',  legs: 'WORKER_HOSE', feet: 'SANDALS' }, inventory: ['BREAD', 'WOODEN_BOWL'] },
    'Laborer': { equipment: { torso: 'SIMPLE_TUNIC', legs: 'WORKER_TROUSERS', feet: 'LEATHER_BOOTS', main_hand: 'STICK' }, inventory: ['BREAD', 'ROPE'] },
    'Peasant': { equipment: { torso: 'PEASANT_TUNIC', feet: 'SANDALS', main_hand: 'HARVEST_SICKLE' }, inventory: ['BREAD_CRUST', 'VEGETABLES'] },
    'Warrior': { equipment: { torso: 'LEATHER_APRON', feet: 'LEATHER_BOOTS', main_hand: 'SWORD' }, inventory: ['MEAT', 'WHETSTONE'],  companions: ['DOG'] },
    'Caretaker': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['HERB_BUNDLE', 'BREAD', 'BANDAGE'] },
    'Mother': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['BREAD', 'SIMPLE_RING', 'FRUIT'] },

    // =======================================================================
    // == HERDERS & ANIMAL-RELATED (Culturally specified)
    // =======================================================================
    'Shepherd': { equipment: { main_hand: 'STICK', torso: 'WOOL_TUNIC' }, inventory: ['BREAD', 'FLUTE'], companions: ['SHEEP', 'DOG'] },
    'Farmer': { equipment: { head: 'STRAW_HAT', main_hand: 'HARVEST_SICKLE', torso: 'LEATHER_APRON' }, inventory: ['BARLEY', 'WHEAT', 'GRAIN_FLAIL'], companions: ['COW'] },
    'Goat Herder': { equipment: { main_hand: 'STICK', torso: 'WOOL_TUNIC' }, inventory: ['CHEESE'], companions: ['GOAT', 'GOAT', 'GOAT'] },
    'Cattle Herder': { equipment: { main_hand: 'STICK', torso: 'WOOL_TUNIC' }, inventory: ['ROPE', 'BREAD'], companions: ['COW', 'COW'] },
    'Camel Herder': { equipment: { main_hand: 'STICK', torso: 'DESERT_CLOAK', head: 'KEFFIYEH' }, inventory: ['DATES', 'GOURD_FLASK'], companions: ['CAMEL', 'CAMEL'] },
    'Duck Herder': { equipment: { main_hand: 'STICK', torso: 'WOOL_TUNIC' }, inventory: ['BREAD'], companions: ['DUCK', 'DUCK', 'DUCK'] },
    'Llama Herder': { equipment: { head: 'CHULLO_HAT', torso: 'PONCHO' }, inventory: ['POTATO', 'ROPE'], companions: ['LLAMA', 'LLAMA'] },
    'Ranchero': { equipment: { head: 'WIDE_BRIM_HAT', feet: 'LEATHER_BOOTS', main_hand: 'ROPE' }, inventory: ['SALT_PORK', 'GOURD_FLASK'], companions: ['COW', 'HORSE'] },
    'Horse Trainer': { equipment: { torso: 'LEATHER_APRON', feet: 'LEATHER_BOOTS' }, inventory: ['ROPE', 'FRUIT'], companions: ['HORSE', 'HORSE'] },
    ...
    // --- PREHISTORY ---
    'Hunter': { equipment: { torso: 'DEER_HIDE', feet: 'HIDE_BOOTS', main_hand: 'STICK' }, inventory: ['FLINT_STONE', 'MEAT', 'VINE'], companions: ['DOG'] },
    'Gatherer': { equipment: { torso: 'DEER_HIDE' }, inventory: ['WILD_BERRIES', 'MUSHROOM', 'ROOT', 'LEATHER_BAG'] },
    'Shaman': { equipment: { head: 'WOLF_PELT', torso: 'FUR_CLOAK' }, inventory: ['HERB_BUNDLE', 'SMOOTH_STONE', 'BONES', 'OWL_FEATHER'] },
    'Toolmaker': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['FLINT_STONE', 'STICK', 'VINE', 'HAMMER'] },
    'Healer': { equipment: { torso: 'DEER_HIDE' }, inventory: ['MEDICINAL_HERBS', 'HERB_BUNDLE', 'SMOOTH_STONE'] },
    'Cave Painter': { equipment: { torso: 'DEER_HIDE' }, inventory: ['OCHRE_LUMP', 'COAL', 'CLAY_LUMP'] },
    'Fire Keeper': { equipment: { torso: 'DEER_HIDE' }, inventory: ['STICK', 'DRY_LEAVES', 'FLINT_STONE'] },
    'Skin Dresser': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['DEER_HIDE', 'FLINT_STONE', 'KNIFE'] },
    'Fisher': { equipment: { main_hand: 'STICK' }, inventory: ['FISH_MEAT', 'VINE', 'EARTHWORM'] },
    'Bone Carver': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['BONES', 'FLINT_STONE', 'KNIFE'] },

    // --- ANTIQUITY ---
    'Merchant': { equipment: { torso: 'CITIZEN_TOGA', belt: 'PURSE', main_hand: 'SWORD' }, inventory: ['SCALE', 'COIN', 'AMPHORA', 'OLIVES'] }, // Requires AMPHORA
    'Physician': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['MEDICINAL_HERBS', 'BANDAGE', 'SCROLL', 'BRONZE_PIN'] },
    'Scribe': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['SCROLL', 'QUILL', 'INK_POT', 'PARCHMENT_ROLL'] },
    'Lawyer': { equipment: { torso: 'CITIZEN_TOGA' }, inventory: ['BOOK', 'SCROLL', 'QUILL', 'COIN'] },
    'Teacher': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['BOOK', 'SCROLL', 'STICK'] },
    'Architect': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['PARCHMENT_ROLL', 'SCALE', 'STONE_CHISEL'] },
    'Legionary': { equipment: { torso: 'LEATHER_APRON', feet: 'MILITARY_SANDALS', main_hand: 'STICK' }, inventory: ['BREAD', 'SALT'] },
    'Auxiliary': { equipment: { torso: 'LEATHER_APRON', main_hand: 'SWORD' }, inventory: ['SMOOTH_STONE', 'BREAD'] },
    'Centurion': { equipment: { head: 'BATTLE_HELMET', torso: 'LEATHER_APRON', feet: 'MILITARY_SANDALS', main_hand: 'SWORD' }, inventory: ['BREAD', 'WHETSTONE'] },
    ...
    'Carpenter': { equipment: { torso: 'LEATHER_APRON', main_hand: 'AXE' }, inventory: ['HAMMER', 'NAILS', 'STICK'] },
    'Stonemason': { equipment: { torso: 'LEATHER_APRON', main_hand: 'HAMMER' }, inventory: ['STONE_CHISEL', 'STONE_BLOCK'] },
    'Glassblower': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['GLASS_BOTTLE', 'BELLOWS', 'PINE_RESIN'] },
    'Jeweler': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['SILVER_ORE', 'HAMMER', 'SIMPLE_RING'] },
    'Tanner': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['COW_HIDE', 'SALT', 'KNIFE'] },
    'Fuller': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['BUCKET', 'SOAP'] },
    'Slave': { equipment: { torso: 'SLAVE_TUNIC' }, inventory: [] },
    'Vintner': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['GRAPES', 'WOODEN_BOWL', 'GLASS_BOTTLE'] },
    'Miller': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['WHEAT', 'FLOUR'] },
    'Tavern Keeper': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['WOODEN_BOWL', 'BREAD', 'KEY'] },
    'Gladiator': { equipment: { torso: 'LEATHER_APRON', main_hand: 'SWORD' }, inventory: ['BANDAGE'] },
    ...
    'Priest': { equipment: { torso: 'LINEN_ROBE' }, inventory: ['INCENSE', 'RELIGIOUS_TEXT', 'CLAY_LAMP'] },
    'Temple Keeper': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['INCENSE', 'CANDLES', 'BROOM'] },
    'Oracle': { equipment: { torso: 'SILK_ROBE' }, inventory: ['HERB_BUNDLE', 'BLESSED_ARTIFACT'] },

    // --- MEDIEVAL ---
    'Knight': { equipment: { torso: 'LEATHER_APRON', feet: 'LEATHER_BOOTS', main_hand: 'SWORD', belt: 'PURSE' }, inventory: ['SALT_PORK', 'WHETSTONE'], companions: ['HORSE'] },
    'Squire': { equipment: { torso: 'LEATHER_APRON', main_hand: 'SWORD' }, inventory: ['WHETSTONE', 'FRUIT', 'BANDAGE'] },
    'Lady': { equipment: { head: 'VEIL', torso: 'MERCHANT_GOWN' }, inventory: ['SIMPLE_RING', 'BOOK', 'SILK_CLOTH'] },
    'Page': { equipment: { torso: 'CRAFTSMAN_TUNIC' }, inventory: ['SWORD', 'FRUIT'] },
    'Nun': { equipment: { head: 'WIMPLE', torso: 'SIMPLE_ROBE' }, inventory: ['BREAD', 'RELIGIOUS_TEXT', 'PRAYER_BEADS'] },
    'Pilgrim': { equipment: { torso: 'WOOL_CLOAK', main_hand: 'STICK' }, inventory: ['BREAD', 'GOURD_FLASK', 'PRAYER_BEADS'] },
    'Friar': { equipment: { torso: 'SIMPLE_ROBE', feet: 'SANDALS', main_hand: 'STICK' }, inventory: ['BREAD', 'RELIGIOUS_TEXT'] },
    'Pardoner': { equipment: { torso: 'SIMPLE_ROBE', belt: 'PURSE' }, inventory: ['SCROLL', 'COIN', 'BLESSED_ARTIFACT'] },
    'Hermit': { equipment: { torso: 'ROUGH_TUNIC', main_hand: 'STICK' }, inventory: ['HERB_BUNDLE', 'WOODEN_BOWL'] },
    ...
    'Bell Founder': { equipment: { torso: 'LEATHER_APRON', main_hand: 'HAMMER' }, inventory: ['COPPER_INGOT', 'TIN_INGOT', 'BELLOWS'] },
    'Chandler': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['CANDLES', 'BEESWAX', 'VINE'] },
    'Dyer': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['OCHRE_LUMP', 'BUCKET', 'WOOL_TUNIC'] },
    'Guild Master': { equipment: { torso: 'MERCHANT_GOWN', belt: 'PURSE' }, inventory: ['KEY', 'COIN', 'BOOK'] },
    'Wool Merchant': { equipment: { torso: 'WOOL_CLOAK' }, inventory: ['SCALE', 'WOOL_TUNIC', 'PURSE'] },
    'Money Changer': { equipment: { torso: 'WOOL_TUNIC', belt: 'PURSE' }, inventory: ['COIN', 'COIN', 'COIN', 'SCALE'] },
    'Brewer': { equipment: { torso: 'LEATHER_APRON' }, inventory: ['BARLEY', 'BUCKET', 'WOODEN_BOWL'] },
    'Guard': { equipment: { head: 'LEATHER_CAP', torso: 'LEATHER_APRON', main_hand: 'STICK' }, inventory: ['BREAD'] },
    'Thief': { equipment: { head: 'CLOTH_HOOD', torso: 'WOOL_TUNIC', feet: 'LEATHER_BOOTS', main_hand: 'SWORD', belt: 'PURSE' }, inventory: ['LOCKPICK', 'ROPE', 'KNIFE'] },
    'Beggar': { equipment: { torso: 'ROUGH_TUNIC' }, inventory: ['WOODEN_BOWL', 'BREAD_CRUST'] },
    ...
    'Executioner': { equipment: { head: 'CLOTH_HOOD', torso: 'LEATHER_APRON', main_hand: 'AXE' }, inventory: ['ROPE', 'WHETSTONE'] },
    'Falconer': { equipment: { torso: 'LEATHER_TUNIC', arm: 'LEATHER_BRACER' }, inventory: ['MEAT'], companions: ['EAGLE'] },
    'Charcoal Burner': { equipment: { torso: 'LEATHER_APRON', main_hand: 'AXE' }, inventory: ['COAL', 'STICK'] },
    'Woodcutter': { equipment: { torso: 'LEATHER_APRON', main_hand: 'AXE' }, inventory: ['ROPE', 'STICK'] },
    'Washerwoman': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['BUCKET', 'SOAP'] },
    'Wet Nurse': { equipment: { torso: 'SIMPLE_ROBE' }, inventory: ['MILK_BOTTLE', 'BREAD'] },
