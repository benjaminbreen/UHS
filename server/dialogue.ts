...
export async function dialogue(
  ...
  try {
    ...
    return json({ text: parsed.data.dialogue, receive: parsed.data.receive, model: "gpt-5.6-luna" });
  } catch {
