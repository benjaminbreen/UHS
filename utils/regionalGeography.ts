...
const REGION_COORDINATES: { [region: string]: { lat: number; lng: number } } = {
  ...
  // Africa
  'Sahel': { lat: 15, lng: 10 },
  'Upper Guinea': { lat: 10, lng: -10 },
  'West African Forests': { lat: 7, lng: 0 },
  'Lower Guinea and Congo Basin': { lat: -2, lng: 20 },
  'Central Africa': { lat: 0, lng: 25 },
  'East African Rift': { lat: -3, lng: 36 },
  'Horn of Africa': { lat: 8, lng: 45 },
  'Southern Africa': { lat: -20, lng: 25 },
  'Madagascar and Islands': { lat: -19, lng: 47 },
  ...
  // East Asia
  'North China Plain': { lat: 38, lng: 116 },
  'South China': { lat: 25, lng: 113 },
  'West China and Tibet': { lat: 32, lng: 90 },
  'Mongolia and Manchuria': { lat: 45, lng: 110 },
  'Korea': { lat: 37, lng: 127 },
  'Japan': { lat: 36, lng: 138 },
  'Taiwan and Ryukyu': { lat: 24, lng: 121 },
  'Taiwan and East China Sea': { lat: 26, lng: 120 },
  'Xinjiang': { lat: 42, lng: 85 },
  'Central Asian Oases': { lat: 40, lng: 70 },
  'Kazakh Steppes': { lat: 48, lng: 68 },
  'Siberia': { lat: 60, lng: 100 },

  // Southeast Asia
  'Mainland Southeast Asia': { lat: 16, lng: 102 },
  'Indochina Interior': { lat: 18, lng: 105 },
  'Maritime Southeast Asia': { lat: -2, lng: 115 },
  'Philippines': { lat: 12, lng: 122 },
  'Indonesian and Melanesian Islands': { lat: -5, lng: 120 },

  // Oceania
  'Australia – North and Queensland': { lat: -20, lng: 145 },
  'Australia – Outback and Center': { lat: -25, lng: 133 },
  'Australia – Southeast': { lat: -35, lng: 147 },
  'Australia – West and Desert': { lat: -27, lng: 122 },
  'New Zealand': { lat: -42, lng: 174 },
  'New Guinea and Melanesia': { lat: -6, lng: 147 },
  'Micronesia': { lat: 7, lng: 158 },
  'Polynesia': { lat: -17, lng: -149 },
  'Hawaii and Central Pacific': { lat: 20, lng: -157 },

  // North America
  'Canada': { lat: 60, lng: -95 },
  'Arctic and Subarctic': { lat: 70, lng: -100 },
  'Northeastern Seaboard': { lat: 42, lng: -73 },
  'Atlantic Coast': { lat: 35, lng: -78 },
  'Southeast': { lat: 32, lng: -85 },
  'Great Plains': { lat: 40, lng: -100 },
  'Mississippi Valley': { lat: 35, lng: -90 },
  'Southwest': { lat: 35, lng: -108 },
  'Mexico and Central Highlands': { lat: 20, lng: -100 },
  'Northern Rockies': { lat: 45, lng: -113 },
  'Pacific Coast': { lat: 40, lng: -122 },
  'Northern California': { lat: 40, lng: -122 },
  'Central California Coast': { lat: 36, lng: -121 },
  'Southern California': { lat: 34, lng: -118 },

  // Central America & Caribbean
  'Central America': { lat: 12, lng: -86 },
  'The Caribbean': { lat: 18, lng: -70 },
  'Atlantic Islands': { lat: 32, lng: -17 },

  // South America
  'Llanos and Orinoco': { lat: 7, lng: -68 },
  'Guiana Shield': { lat: 4, lng: -60 },
  'Amazon Basin': { lat: -5, lng: -60 },
  'Andes North': { lat: -2, lng: -78 },
  'Andes South': { lat: -30, lng: -70 },
  'Gran Chaco and Pampas': { lat: -30, lng: -60 },
  'Southern Highlands': { lat: -20, lng: -50 },
  'Patagonia': { lat: -45, lng: -70 },
