...
export const egypt: readonly BeliefSystem[] = [
  {
    ...
    powers: [
      ...
      { name: "Osiris", domain: "the dead, renewal, the flood", rank: "major" },
      {
        name: "Isis",
      ...
      { name: "Ptah", domain: "craft, making", rank: "major" },
      { name: "Thoth", domain: "writing, reckoning", rank: "major" },
      {
        name: "Sekhmet",
      ...
      { name: "Bes", domain: "childbirth, the household door", rank: "local" },
      { name: "Taweret", domain: "pregnancy, infants", rank: "local" },
      {
        name: "Meretseger",
