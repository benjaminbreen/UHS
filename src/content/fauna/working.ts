...
export const workingFauna: readonly FaunaProfile[] = [
  ...
  },
  {
    ...
    habitats: [
      ...
      { tag: "pasture", weight: 0.8 },
      { tag: "shore", weight: 0.5 },
    ],
    // River buffalo tamed in the Indus valley, swamp buffalo in southern China
    // and the Mekong for the rice fields. West with the caliphate to Iraq and
    // Egypt, and with the Lombards to Italy.
    presence: [
      { years: [-3000, 10000], bounds: [60, 5, 97, 36] },
      { years: [-2500, 10000], bounds: [95, -11, 125, 32] },
      { years: [-1000, 10000], bounds: [95, -11, 142, 20] },
      { years: [600, 10000], bounds: [40, 25, 62, 40] },
      { years: [600, 10000], bounds: [8, 37, 30, 47] },
    ...
    prey: "ungulate",
    diet: ["grass", "plant"],
    ...directionalStudy("water-buffalo"),
  },
  {
    id: "dog",
    label: "Dog study",
