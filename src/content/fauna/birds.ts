...
export const birds: readonly FaunaProfile[] = [
  ...
  },
  {
    ...
    // Africa, Iberia, the Near East and monsoon Asia of old. It crossed the
    // Atlantic unaided to the Guianas by 1877 and was breeding in Florida by
    // 1953; it reached Australia on its own in the late 1940s.
    presence: [
      ...
      { years: [1948, 10000], bounds: [112, -44, 154, -10] },
    ],
    density: 1.2,
    pace: 0.7,
    followsHerds: true,
