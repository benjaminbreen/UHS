...
export const propDefs: Record<string, PropDef> = {
  ...
  tripHammer: {
    solid: true,
    name: "Foot trip-hammer",
    family: "trip-hammer",
    variants: 2,
    where: "worksite",
    span: [1, 0],
    visualClearance: [1, 2, 1, 0],
  },
  travois: {
    solid: true,
    name: "Travois",
  ...
  backstrapLoom: {
    name: "Backstrap loom",
    family: "backstrap-loom",
    variants: 2,
    where: "backyard",
    visualClearance: [1, 1, 0, 0],
  },
  dungStack: {
    solid: true,
    name: "Dung-cake stack",
    family: "dung-stack",
    variants: 2,
    where: "backyard",
  },
