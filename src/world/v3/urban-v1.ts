...
import { urbanFrames, type UrbanLot } from "./urban";
...
/** The first urban composition, retained for worlds pinned to `urbanRevision: 1`.
 * Four fixed blocks on one 3x3 lattice, with no cultural or dated input. New
 * worlds use the block grammar in `urban.ts`; this is not extended.
 *
 ...
 */
export function urbanNeighborhoodV1(
  site: Site,
  pack: Pack,
  seed: string,
  connect: Connect,
