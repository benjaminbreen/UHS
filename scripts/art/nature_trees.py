...
BIRCH = ['#1b2c26', '#34522c', '#597e2f', '#7fa335', '#b4c357', '#d5d888']
TROPICAL = ['#0c2a26', '#154c3e', '#267543', '#43953d', '#78b84c', '#b3cc73']
WILLOW = ['#182b26', '#2f5137', '#4f7e3e', '#769c46', '#a3bb67', '#cbd38e']
SCRUB = ['#293025', '#485430', '#707d3d', '#93a05b', '#bec483', '#dad39d']
