/**
 * components/symbols/UrbanSymbolSimplified.tsx - Urban buildings using unified selection system
 * This version replaces the complex conditional logic with the centralized selection system
 */
...
const UrbanSymbolSimplified: React.FC<UrbanSymbolProps> = React.memo(({ 
  ...
  const selectedBuildingData = useMemo(() => {
    // Enable logging for debugging on the first urban tile
    const enableLogging = typeof window !== 'undefined' && 
                          !window.urbanSymbolLogged && 
  ...
  const renderBuilding = () => {
    ...
    if (!BuildingComponent) {
      console.error(`[UrbanSymbolSimplified] No building component selected!`);
      return null;
    }
...
export default UrbanSymbolSimplified;