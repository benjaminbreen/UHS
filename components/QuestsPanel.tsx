...
const QuestsPanel: React.FC<QuestsPanelProps> = ({
  ...
  // DISABLED: Legacy quest system - replaced with work offers
  ...
  // DISABLED: Legacy quest system - renderObjective and renderQuest functions removed
  // These were part of the old quest system that has been replaced with work offers
